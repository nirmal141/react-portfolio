...
const Home = () => {
 ...
 from-black via-black to-gray-800'>
        ...
        <div className=' text-white max-w-screen-lg mx-auto flex flex-col
        items-center justify-between h-full px-4 md:flex-row
        '>
            <div className='flex flex-col justify-center h-full'>
                ...
                '>
                    I have 2 years of experience in building and designing 
                    softwares.
